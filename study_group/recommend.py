...
def create_recommand_csv(request):
    ...
    # print('recommend_tags_table:', recommend_tags_table)
    for id in users_id:
        # print(id)
        # print("max_len:", dir(user_based_collab.loc[id]))
        print("max_len:", user_based_collab.loc[id].size)
